 ...
 *   1) 登录拿真实 session cookie（测试环境 India/admin/123456）
 ...
 *
 * 用法（tsx 解析 .ts 模块）：
 *   npx tsx scripts/eval-trace-gate.mjs --prompt-file scripts/_p.txt
 *   EVAL_COUNTRY=india EVAL_USER=admin EVAL_PASS=123456 npx tsx scripts/eval-trace-gate.mjs
 */
...
async function main() {
  ...
  const results = assertTraceGates({ spans, rejectMode: "observe" });
